...
void Level4::startLevel() {
  ...
  while (!Question::question({&answer0_0, &answer1_0, &answer2_0},
  ...
  while (!Question::question({&answer0_1, &answer1_1, &answer2_1},
  ...
  while (!Question::question({&answer0_2, &answer1_2, &answer2_2},
